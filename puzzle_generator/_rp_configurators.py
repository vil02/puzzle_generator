...
from . import _puzzle_data_encryption as pde
from . import _randomise_index as ri
from . import _run_puzzle as rp
from . import _string_to_code
...
class _NoHintsConfigurator:
    ...
    def puzzle_data(
        ...
        question = _string_to_code.string_to_code(in_encrypted_puzzle[0], 78, '"""')
        rest_str = _string_to_code.string_to_code(
